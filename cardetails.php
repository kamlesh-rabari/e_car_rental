...
<div class="search-container">
    <input type="text" id="searchInput" placeholder="Search for a car..." onkeyup="filterCars()">
</div>
        ...
        <li class="car-item">
            <div class="box">
                ...
                <div class="content">
                    ...
                    <button class="utton" style="margin-top: 5px;">
                        <a href="booking.php?id=<?php echo $result['CAR_ID']; ?>">Book</a>
                    </button>
                </div>
            </div>
        </li>
...
function filterCars() {
    ...
    cars.forEach(car => {
        let carName = car.querySelector('.car-name').innerText.toUpperCase();
